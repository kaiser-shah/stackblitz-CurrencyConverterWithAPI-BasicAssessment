...
//     );
//     allCurrency = await response.json();
//     addCurrencyToDropdowns(); // ✅ Correct function call
//   } catch (error) {
//     console.log('Error fetching data', error);
//   }
// }

// function addCurrencyToDropdowns() {
//   const currencyIds = Object.keys(allCurrency); // ['usd', 'eur', etc.]

//   currencyIds.forEach((currency) => {
//     const option1 = document.createElement('option');
//     option1.value = currency;
//     option1.textContent = currency.toUpperCase();
//     fromCurrency.appendChild(option1); // ✅ append to fromCurrency

//     const option2 = document.createElement('option');
//     option2.value = currency;
//     option2.textContent = currency.toUpperCase();
//     toCurrency.appendChild(option2); // ✅ append to toCurrency
//   });
// }
